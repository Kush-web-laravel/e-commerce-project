                ...
                <form class="form-horizontal" id="categoryForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="categoryName" name="category_name" autocomplete="off">
                    ...
                    if(categoryImage == ''){
                        ...
                        if(categoryImage != ''){
                            ...
                            if(jQuery.inArray(extension, ['gif','png','jpg','jpeg']) == -1){
                                $('#categoryImageErr').addClass('error');
                                $('#categoryImageErr').text('Invalid image file').css('font-weight','bold');
                                temp++;
                            }else{
